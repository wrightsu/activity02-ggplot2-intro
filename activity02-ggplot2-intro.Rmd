...
<<<<<<< HEAD
**Response**: The flipper length is disparate enough that it's easy to see the overlap/lack of overlap using this display type. I also appreciate the auto creation of a the colors and the color key.
=======
...
**Response**: Boxplots make it easier to see outliers. Jitterplots make it easier to see overlapping data.
...
**Response**: The md file. Very nicely formatted and with very pretty pictures.
...
**Response**: One you get the structure down, it doesn't seem that hard to manipulate aesthetics.
...
**Response**: Species and island seem to be the biggest contributor. Sex has the most overlap.
...
**Response**: Gentoos have large body mass and bigger flipperrs. Adelie and chinstraps are similarly sized, though adelies hit the smaller end of the range.
...
**Response**: Gives a visual respresentation of size of animal and allows data points to more easily been seen.
